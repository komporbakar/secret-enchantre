        ...
        <div className="flex flex-wrap">
          <div className="lg:w-3/4 w-full  shadow-lg border rounded-md">
            <div className=" px-4 py-2 ">
              <div
                id="Thead"
                className=" flex-wrap hidden lg:flex  text-[#5A5A5A]"
              >
              ...
              {data &&
                data?.map((item, i) => {
                  return <ListCart key={i} data={item} />;
                })}
          ...
          <div className="lg:w-1/4 w-full mt-5 lg:mt-0 ">
            <div className="rounded-md shadow-lg lg:ms-3 border">
              <div className="flex flex-wrap justify-between px-6 mt-10 items-center mb-2">
                <p className="text-base">Subtotal</p>
                <p className="text-base">
                  Rp. {new Intl.NumberFormat("en-DE").format(`${total_price}`)}
                </p>
              </div>
              <div className="flex flex-wrap justify-between px-6 items-center mb-4">
              ...
              <div className="px-6 mb-4">
                <Link
                  href="/checkout"
                  className="bg-black rounded-lg flex justify-center py-3 text-white "
                >
                  <p className="text-center">Checkout Now</p>
                </Link>
              </div>
            </div>
          </div>
